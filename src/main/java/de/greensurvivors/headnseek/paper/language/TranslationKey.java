...
public enum TranslationKey {
    ...
    CMD_CONFIGURE_HEAD_REPLACED("cmd.configureHead.replaced"),
    CMD_DEFINE_BOARD_START("cmd.defineBoard.start"),
    CMD_REMOVE_BOARD_ALL_SUCCESS("cmd.removeBoard.all.success"),
    CMD_REMOVE_BOARD_WORLD_SUCCESS("cmd.removeBoard.world.success"),
    CMD_REMOVE_BOARD_NEAR_SUCCESS("cmd.removeBoard.near.success"),
    CMD_GET_SUCCESS("cmd.get.success"),
